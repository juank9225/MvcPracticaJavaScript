...
(function(){
 ...
 (function(){
     ...
     function hit(a, b) {
       if (this.ball.x < 0 || this.ball.x > 800) {
         ...
         mensaje.innerHTML = "<h3 style='color:red;'>Game over!</h3>";
         setTimeout(function () {
           location.reload();
              }, 3000);
            }
 ...
 var bar = new Bar(20,100,15,100,board);
 var bar_2 = new Bar(733,100,15,100,board);

var bar_up = new Bar(0, 0, 800, 3, board);//Side bars
var bar_down = new Bar(0, 397, 800, 6, board);//Side bars
